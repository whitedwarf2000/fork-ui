      ...
      render: (setOpen) => (
        <div className="flex">
          ...
          <div className="flex flex-col">
            <span>
              <a className="text-blue-600" onClick={() => setOpen(false)}>Hoàng Nguyễn </a>
              send you a friend request
            </span>
            <div className="mt-1 text-gray-600">
              <Icon name="globe" className="mr-2" fontSize="0.85em" />
              5 minues ago, <i>click <a className="text-blue-600" onClick={() => setOpen(false)}>Hoàng Nguyễn </a> to close</i>
            </div>
          </div>
        </div>
      ),
