...
var TR = function TR(_ref) {
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("tr", (0, _extends2["default"])({
    className: (0, _classnames["default"])('rc-table-tr', {
      '--header': isHeader,
      '--footer': isFooter
    }, className)
  }, otherProps)), (expander || belongBody) && _react["default"].createElement("tr", {
